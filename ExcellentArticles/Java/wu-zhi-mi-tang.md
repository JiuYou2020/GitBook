...
5. **扩容：** 如果添加元素后 `HashMap` 中的元素数量达到数组容量的阈值（负载因子，默认为0.75），会触发扩容操作。扩容会将数组容量增加一倍，并重新计算每个键值对的存放位置。![image-20240412211604182](/home/jiuyou2020/文档/GitBook/ExcellentArticles/Java/.gitbook/assets/image-20240412211604182.png)
...
![image-20240412213114649](/home/jiuyou2020/文档/GitBook/ExcellentArticles/Java/.gitbook/assets/image-20240412213114649.png)
